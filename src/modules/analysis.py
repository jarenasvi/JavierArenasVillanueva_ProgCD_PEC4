...
def analyze_dataset(merged_df):
    ...
    Parámetros:
        merged_df (pd.DataFrame): dataframe fusionado.

    Devuelve:
        Genera el JSON con la información:
            1. Metadata
    ...
    output_path = os.path.join(output_dir, "evolucion_JavierArenasVillanueva.json")
